...
fn calc_3d_shadow(model: mat4x4<f32>, position: vec4<f32>, normal: vec3<f32>) -> vec4<f32> {
...
fn vs_main(
    ...
    result.color = entity.color * calc_3d_shadow(world_position, entity_position, normal);

...
use super::{
    ...
    scene::Scene,
    uniform::ShadowEntityUniformBuffer,
    RenderedEntity,
};
...
impl ShadowBaker {
    ...
    pub(super) fn new(
        ...
        let (entity_uniform_size, entity_uniform_buf, _) = RenderedEntity::make_uniform(
            device,
            entity_len,
            mem::size_of::<ShadowEntityUniformBuffer>() as wgpu::BufferAddress,
        );
